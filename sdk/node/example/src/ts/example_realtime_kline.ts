...
const klineData: Record<number, Record<string, KLine>> = {};

const timeInterval = 60;

function onTradeData(topic: string, subject: string, tradeEvent: Spot.SpotPublic.TradeEvent): void {
