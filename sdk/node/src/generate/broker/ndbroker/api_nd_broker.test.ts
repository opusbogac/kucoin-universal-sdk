...
describe('Auto Test', () => {
    ...
    test('getDepositList response test', () => {
        ...
        let resp = new GetDepositListResp();
    ...
    test('getSubAccountAPI request test', () => {
         ...
         */
        let data = '{"uid": "226383154", "apiKey": "671afb36cee20f00015cfaf1"}';
        let req = new GetSubAccountAPIReq();
        req = req.fromJson(data);
        expect(Object.values(req).every((value) => value === null || value === undefined)).toBe(
            false,
        );
    ...
    test('getSubAccountAPI response test', () => {
        ...
        let commonResp = RestResponse.fromJson(data);
        let resp = new GetSubAccountAPIResp();
        resp = resp.fromObject(commonResp.data);
        expect(Object.values(resp).every((value) => value === null || value === undefined)).toBe(
            false,
        );
    ...
    test('getSubAccount response test', () => {
        ...
        let commonResp = RestResponse.fromJson(data);
        let resp = new GetSubAccountResp();
        resp = resp.fromObject(commonResp.data);
        expect(Object.values(resp).every((value) => value === null || value === undefined)).toBe(
            false,
        );
    ...
    test('getBrokerInfo response test', () => {
        ...
        let data =
            '{\n    "code": "200000",\n    "data": {\n        "accountSize": 0,\n        "maxAccountSize": null,\n        "level": 0\n    }\n}';
        let commonResp = RestResponse.fromJson(data);
        let resp = new GetBrokerInfoResp();
        resp = resp.fromObject(commonResp.data);
        expect(Object.values(resp).every((value) => value === null || value === undefined)).toBe(
            false,
        );
    ...
    test('getDepositDetail request test', () => {
        ...
        let req = new GetDepositDetailReq();
        req = req.fromJson(data);
        expect(Object.values(req).every((value) => value === null || value === undefined)).toBe(
            false,
        );
    ...
    test('getDepositDetail response test', () => {
        ...
        let commonResp = RestResponse.fromJson(data);
        let resp = new GetDepositDetailResp();
        resp = resp.fromObject(commonResp.data);
        expect(Object.values(resp).every((value) => value === null || value === undefined)).toBe(
            false,
        );
    ...
    test('getTransferHistory request test', () => {
        ...
        let req = new GetTransferHistoryReq();
        req = req.fromJson(data);
        expect(Object.values(req).every((value) => value === null || value === undefined)).toBe(
            false,
        );
    ...
    test('getTransferHistory response test', () => {
        ...
        let commonResp = RestResponse.fromJson(data);
        let resp = new GetTransferHistoryResp();
        resp = resp.fromObject(commonResp.data);
        expect(Object.values(resp).every((value) => value === null || value === undefined)).toBe(
            false,
        );
    ...
    test('getWithdrawDetail request test', () => {
        ...
        let req = new GetWithdrawDetailReq();
        req = req.fromJson(data);
        expect(Object.values(req).every((value) => value === null || value === undefined)).toBe(
            false,
        );
    ...
    test('getWithdrawDetail response test', () => {
        ...
        let commonResp = RestResponse.fromJson(data);
        let resp = new GetWithdrawDetailResp();
        resp = resp.fromObject(commonResp.data);
        expect(Object.values(resp).every((value) => value === null || value === undefined)).toBe(
            false,
        );
