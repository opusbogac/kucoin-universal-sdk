...
export class AddDepositAddressV1Resp implements Response<AddDepositAddressV1Resp, RestResponse> {
    /**
     * Deposit address
     */
    address?: string;
    ...
    fromJson(input: string): AddDepositAddressV1Resp {
        const jsonObject = JSON.parse(input);
        return plainToInstance(AddDepositAddressV1Resp, jsonObject);
    }
    ...
    fromObject(jsonObject: Object): AddDepositAddressV1Resp {
        return plainToInstance(AddDepositAddressV1Resp, jsonObject);
    }
}
