...
export class FlexTransferReq implements Serializable<FlexTransferReq> {
    /**
    ...
    static builder(): FlexTransferReqBuilder {
        return new FlexTransferReqBuilder();
    }
    ...
    fromJson(input: string): FlexTransferReq {
        const jsonObject = JSON.parse(input);
        return plainToInstance(FlexTransferReq, jsonObject);
    }
    ...
    fromObject(jsonObject: Object): FlexTransferReq {
        return plainToInstance(FlexTransferReq, jsonObject);
    }
}
...
export class FlexTransferReqBuilder {
    obj: FlexTransferReq = new FlexTransferReq();
    /**
     * Unique order id created by users to identify their orders, e.g. UUID, with a maximum length of 128 bits
     */
