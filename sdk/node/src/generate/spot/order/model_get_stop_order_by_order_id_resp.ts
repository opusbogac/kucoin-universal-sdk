...
export class GetStopOrderByOrderIdResp
    implements Response<GetStopOrderByOrderIdResp, RestResponse>
{
    /**
    ...
    fromJson(input: string): GetStopOrderByOrderIdResp {
        const jsonObject = JSON.parse(input);
        return plainToInstance(GetStopOrderByOrderIdResp, jsonObject);
    }
    ...
    fromObject(jsonObject: Object): GetStopOrderByOrderIdResp {
        return plainToInstance(GetStopOrderByOrderIdResp, jsonObject);
    }
}
