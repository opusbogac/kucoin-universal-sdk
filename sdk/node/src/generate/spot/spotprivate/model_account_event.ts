...
export class AccountEvent implements Response<WsMessage> {
    /**
     * Account ID
     */
    accountId?: string;
    ...
    static fromObject(jsonObject: Object): AccountEvent {
        return plainToClassFromExist(new AccountEvent(), jsonObject);
    }
}
...
export class AccountEventCallbackWrapper implements WebSocketMessageCallback {
    ...
    onMessage(msg: WsMessage): void {
        let event = AccountEvent.fromObject(msg.data);
