...
export class OrderV2Event implements Response<OrderV2Event, WsMessage> {
    /**
    ...
    fromJson(input: string): OrderV2Event {
        const jsonObject = JSON.parse(input);
        return plainToInstance(OrderV2Event, jsonObject);
    }

    toJson(): string {
        return JSON.stringify(instanceToPlain(this));
    }
    fromObject(jsonObject: Object): OrderV2Event {
        return plainToInstance(OrderV2Event, jsonObject);
    }
}
...
export class OrderV2EventCallbackWrapper implements WebSocketMessageCallback {
    ...
    onMessage(msg: WsMessage): void {
        let event = new OrderV2Event().fromObject(msg.rawData);
