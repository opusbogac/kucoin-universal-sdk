...
export class GetInterestRateIndexReq implements Serializable<GetInterestRateIndexReq> {
    /**
    ...
    static builder(): GetInterestRateIndexReqBuilder {
        return new GetInterestRateIndexReqBuilder();
    }
    ...
    fromJson(input: string): GetInterestRateIndexReq {
        const jsonObject = JSON.parse(input);
        return plainToInstance(GetInterestRateIndexReq, jsonObject);
    }
    ...
    fromObject(jsonObject: Object): GetInterestRateIndexReq {
        return plainToInstance(GetInterestRateIndexReq, jsonObject);
    }
}

export class GetInterestRateIndexReqBuilder {
    obj: GetInterestRateIndexReq = new GetInterestRateIndexReq();
    /**
     * Symbol of the contract, Please refer to [Get Symbol endpoint: fundingBaseSymbol, fundingQuoteSymbol, fundingBaseSymbol1M, fundingQuoteSymbol1M](https://www.kucoin.com/docs-new/api-3470220)
     */
