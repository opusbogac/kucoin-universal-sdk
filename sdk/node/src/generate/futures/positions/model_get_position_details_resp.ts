...
export class GetPositionDetailsResp implements Response<GetPositionDetailsResp, RestResponse> {
    /**
     * Position ID
     */
    id?: string;
    ...
    fromJson(input: string): GetPositionDetailsResp {
        const jsonObject = JSON.parse(input);
        return plainToInstance(GetPositionDetailsResp, jsonObject);
    }
    ...
    fromObject(jsonObject: Object): GetPositionDetailsResp {
        return plainToInstance(GetPositionDetailsResp, jsonObject);
    }
}
