...
describe('Auto Test', () => {
    test('announcement response test', () => {
        ...
        let resp = AnnouncementEvent.fromObject(commonResp.data);
    ...
    test('execution response test', () => {
        ...
        let commonResp = WsMessage.fromJson(data);
        let resp = ExecutionEvent.fromObject(commonResp.data);
        expect(Object.values(resp).every((value) => value === null || value === undefined)).toBe(
            false,
        );
        console.log(resp);
    ...
    test('instrument response test', () => {
        ...
        let commonResp = WsMessage.fromJson(data);
        let resp = InstrumentEvent.fromObject(commonResp.data);
        expect(Object.values(resp).every((value) => value === null || value === undefined)).toBe(
            false,
        );
        console.log(resp);
    ...
    test('tickerV1 response test', () => {
        ...
        let commonResp = WsMessage.fromJson(data);
        let resp = TickerV1Event.fromObject(commonResp.data);
        expect(Object.values(resp).every((value) => value === null || value === undefined)).toBe(
            false,
        );
        console.log(resp);
    ...
    test('tickerV2 response test', () => {
        ...
        let commonResp = WsMessage.fromJson(data);
        let resp = TickerV2Event.fromObject(commonResp.data);
        expect(Object.values(resp).every((value) => value === null || value === undefined)).toBe(
            false,
        );
        console.log(resp);
